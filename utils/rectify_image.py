...
class CameraParams():
    def __init__(self):
        # cameraMatrix1 = np.array([[820.0758, 0, 665.1652],
        #                           [0, 820.1426, 372.9476],
        #                           [0, 0, 1]])
        # distCoeffs1 = np.array([-0.3976, 0.1643, -0.0003, -0.0001])
        # cameraMatrix2 = np.array([[809.2298, 0, 601.2358],
        #                           [0, 809.6127, 416.0780],
        #                           [0, 0, 1]])
        # distCoeffs2 = np.array([-0.4072, 0.1731, 0.0031, -0.0002])

        # R = np.array([[1, -0.0006, 0.0067],
        #             [0.0006, 1, 0.0042],
        #             [-0.0067, -0.0042, 1]])
        # T = np.array([-354.0233, -1.1110, 1.2614])
